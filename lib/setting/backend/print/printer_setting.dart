...
class _PrinterSettingState extends State<PrinterSetting> {
  ...
  String tips = 'ยังไม่ได้ทำการเชื่อมต่อปริ้นเตอร์';
    ...
    bluetoothPrint.state.listen((state) {
      ...
      switch (state) {
        case BluetoothPrint.CONNECTED:
          setState(() {
            _connected = true;
            tips = 'เชื่อมต่อสำเร็จ';
          });
          break;
        case BluetoothPrint.DISCONNECTED:
          setState(() {
            _connected = false;
            tips = 'ยกเลิกเชื่อมต่อสำเร็จ';
          });
          break;
        default:
          break;
                          ...
                          onPressed: _connected
                              ...
                              : () async {
                                  if (_device != null &&
                                    ...
                                    setState(() {
                                      tips = 'กรุณาทำการเลือกปริ้นเตอร์';
                                    });
                                    print('กรุณาทำการเลือกปริ้นเตอร์');
                                  }
                                },
                        ),
                        SizedBox(width: 10.0),
                        OutlinedButton(
                          child: Text('ไม่เชื่อมต่อ'),
                          onPressed: _connected
                              ? () async {
                                  setState(() {
                                    tips = 'ไม่เชื่อมต่อ...';
